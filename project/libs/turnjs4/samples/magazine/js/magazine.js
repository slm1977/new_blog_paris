...
function loadPage2(page, pageElement) {
...
function loadPage(page, pageElement) {
	...
	// prova integrazione video

        videoTag = $('<video width="200" controls> Your browser does not support HTML5 video.</video>')
    ...
    sourceTag.attr('src', "http://192.168.0.118:5000/static/fotoblog/ristoranti/levieuxbelleville.mp4" )
